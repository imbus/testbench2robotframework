...
#   timestamp: 2026-05-18T16:27:28+00:00
...
class ReportCreation:
    ...
    exportOptions: Optional[ReportExportOptions] = None
...
class TestStructureTree:
    ...
    root: Optional[TestStructureTreeNode] = None
...
class ExecutionImportOptions:
    ...
    updateReferencesList: Optional[ReferenceUpdateMode] = None
    filters: Optional[List[FilterInfo]] = None
...
class ParameterSummary:
    ...
    parentAlias: Optional[str] = None
    rootAlias: Optional[str] = None
    usesCount: Optional[int] = None
